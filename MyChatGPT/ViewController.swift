...
class BTNameListing:UITableViewCell{
    ...
    @IBOutlet weak var lblBtName: UILabel!
}
...
class ViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    @IBOutlet weak var lblNoOfDeveice: UILabel!
    ...
    override func viewDidLoad() {
       ...
       // self.VW.animate(toAngle: "1", duration: 0.5, completion: nil)
        ...
        self.imgGif.image = UIImage.gif(name: "bluetooth2")
    ...
    func centralManagerDidUpdateState(_ central: CBCentralManager) {
      ...
      switch central.state {
        case .poweredOff:
            ...
            let action = UIAlertAction(title: "Go to settings", style: UIAlertAction.Style.default, handler: { (action: UIAlertAction) -> Void in
                self.openBluetooth()
    ...
    func centralManager(_ central: CBCentralManager, didDiscover peripheral: CBPeripheral, advertisementData: [String : Any], rssi RSSI: NSNumber) {
      ...
      if peripheralArray.contains(peripheral) {
        ...
        self.lblNoOfDeveice.text = " : \(peripheralArray.count)"
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverServices error: Error?) {
      ...
      for service in services {
        ...
        self.Myservices = services[0]
        sendData()
    }
    func sendData(){
        let RXCharacteristic = self.Myservices.characteristics?[0].uuid
